...
<div class="middle">
    ...
    <section class="ticketarea flex">
        <div class="rounded-lg w-full mx-4 shadow-lg p-4 bg-main tickets mt-8">
            ...
            <!-- If ticket pendeing admin can accept it and work on it -->
                        <?php 
            if($ticket_status == 'Pending'){
            ?>
            <div class="w-full px-3">
                <form method="post" action="process.php" class="flex">
                    <input type="hidden" name="ticket_id" value="<?php echo $ticket_id; ?>">
                    <input name="accept" type="submit" value="Accept ticket" class="inline-block mx-3 focus:outline-none text-white text-base font-bold py-2.5 px-5 rounded-md bg-yellow-500 hover:bg-yellow-600 hover:shadow-lg items-center">

                    <input name="decline" type="submit" value="Decline ticket" class="inline-block mx-3 focus:outline-none text-white text-base font-bold py-2.5 px-5 rounded-md bg-yellow-500 hover:bg-yellow-600 hover:shadow-lg items-center">

                </form>
            <?php } ?>
            <!-- If ticket is worked on user can mark as finished or reply-->
            <?php 
            if($ticket_status == 'Worked on'){
            ?>
            <div class="w-full px-3">
                <form method="post" action="process.php" >
                    ...
                    <textarea name="Message" class=" no-resize appearance-none block w-full text-gray-100 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:border-gray-500 h-48 resize-none" style="border: 1px solid rgba(204, 163, 84, 0.45);" id="message" ></textarea>
                
                    <input name="submit_reply" type="submit" value="Send" class="inline-block mx-3 focus:outline-none text-white text-base font-bold py-2.5 px-5 rounded-md bg-yellow-500 hover:bg-yellow-600 hover:shadow-lg items-center">
                    <input name="finished" type="submit" value="Mark as finished" class="inline-block mx-3 focus:outline-none text-white text-base font-bold py-2.5 px-5 rounded-md bg-yellow-500 hover:bg-yellow-600 hover:shadow-lg items-center">
